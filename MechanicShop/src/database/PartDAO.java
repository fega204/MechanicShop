...
public class PartDAO {
    ...
    public void addPart(Part part) {
        ...
        try {String sql = "insert into part values(?,?,?,?)";
    ...
    public void showParts() {
        ...
        try {String sql = "select * from part";
    ...
    public Part getPartById(int partId) {
        ...
        try {String sql = "select * from part where part_id = ?";
    ...
    public void updatePartQuantity(int partId, int quantity) {
        ...
        try {String sql = "update part set quantity = ? where part_id = ?";
    ...
    public void deletePart(int partId) {
        ...
        try {String sql = "delete from part where part_id = ?";
